...
public class ApplicationProperty {
    ...
    public String getDonationMerchantAccount() {
        return donationMerchantAccount;
    }

    public void setDonationMerchantAccount(String donationMerchantAccount) {
        this.donationMerchantAccount = donationMerchantAccount;
    }
